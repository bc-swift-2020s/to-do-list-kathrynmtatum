    ...
    UNUserNotificationCenter.current().removeAllPendingNotificationRequests()
        ...
        for index in 0..<toDoItems.count {
            if toDoItems[index].reminderSet {
                ...
                toDoItems[index].notificationID = setCalendarNotification(title: toDoItems[index].name, subtitle: "", body: toDoItem.notes, badgeNumber: nil, sound: .default, date: toDoItem.date)
            }
        }
    }
